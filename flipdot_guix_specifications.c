...
GX_STUDIO_DISPLAY_INFO flipdot_guix_display_table[1] =
{
    ...
    56                                       /* canvas memory size in bytes    */
    }
};
...
UINT gx_studio_named_widget_create(char *name, GX_WIDGET *parent, GX_WIDGET **new_widget)
{
    ...
    GX_CONST GX_STUDIO_WIDGET_ENTRY *entry = flipdot_guix_widget_table;
    GX_WIDGET *widget = GX_NULL;
    ...
    GX_UBYTE language, USHORT theme, GX_WINDOW_ROOT **return_root)
{
    ...
    GX_STUDIO_DISPLAY_INFO *display_info = &flipdot_guix_display_table[display];
